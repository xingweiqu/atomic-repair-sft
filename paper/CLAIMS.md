...
### CL-3 决策与体裁在激活层可分离——双层表述【2026-07-20 拍板1 定稿】
- **杠杆层(跨家族;GSM 域内测得——MC 批限定 2026-07-20)**:决策方向在 Qwen(L12,83→94)与 Llama(L22,resist +17.3、
  能力平 −3.7)均可提取可推;素题代价 Qwen −0.7pp / Llama −3.03pp(后者机械判
  MISS 照记,9/300 题)。
- **红利层(不跨)**:零数据修复腔夺冠(.760)的前提 = 模型自带体裁契约;
  Llama 契约缺席,方向推不出契约(.058)。此拆分解释 E 臂为何赢,并预言
  steering 何时能当一线(→处方 v1.3 前置条款)。
...
- 在册证据(全部多 seed;2026-07-20 拍板2 修订):
  ①修复收益可见度(B2-0b:+10~16 修复腔 vs +2~7 素题,3-seed);
  ②服从类数据的危害(drl25:修复腔 keep −17pp,素题无害);
  ③2Wiki 方向反转(X 加固 3-seed)。
  **退役案例**:scaffold 收益符号翻转(原案例③)——E-15a 补 seed 2/3 反向
  (健康脊点 e4 修复腔 .665/.631 > 安慰剂),判 REVERSE,退役入附录;
  单 seed 退役卷第二案(空心柱规则的胜利)。措辞:"每条在册证据都经过
  多 seed 复现;一个早期单 seed 案例未通过复现,如实退役"。
...
- known-limitation(缩句,拍板2):scafffmt 的"结构 vs JSON"归因停牌(边缘健康污染)
...
### COR-6(2026-07-20,C-15 收割拍板)
E-15a:D、drills 复现 HIT;**scaffold sign-flip REVERSE**(2/3 seed 健康脊点反向,
原 s42@e2 边缘健康伪影)→ CL-6 案例③退役(单 seed 退役卷第二案)。
E-15b:M3-v2 @L22_α6——resist HIT(+17.3)/能力平 HIT(−3.7)/素题 **MISS**
(−3.03 vs ≤3,不四舍五入);科学结论按双层拆(杠杆跨/红利不跨),CL-3 修订如上。
E-15c:双 HIT(α6 甜点 repair .771/mute 3.7%;mute 单调)——压线披露销案。

### COR-7(2026-07-20,矩阵补格批;data-freeze-2 收官条)
MC-1 域迁移三 MISS(2Wiki/SVAMP 判据天花板不可达 max +5.3/+8.3;StratQA 有
headroom 杠杆不动)→ CL-3 杠杆层限定"GSM 域内测得"。MC-2 Mistral
QUAL_BUT_FLAT L26(+7.3 差 2.7 到线,方向为正)。MC-3 2Wiki drills 毒性缺席
HIT(第五连;drl25 修复腔 .476/.487 ≥ 安慰剂 .441;登记:derail 56→18-21,
bare-answer 训练反降脱轨,不解释)。矩阵终版:钩 8 / 变体 4 / 缺席 11 / 灰 4
(全部为声明边界),零 REVERSE。
