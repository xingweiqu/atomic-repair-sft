#!/bin/bash
# lawv1 smoke runner (C-24 #6/#7): 3 arms sequential on one 8-GPU node.
# Per run saves: train_config/data_manifest/train_log/checkpoint_hash/generation_config/
# predictions/scores_by_item/scores_summary/environment/git_commit/DONE.
set -u
