...
- Aggregate → Atomic Failure Profile map; base/placebo profile as first exhibit (interface .71, distractor .843, KEEP .902, abstain .16; K decision .608 with contract .992).
