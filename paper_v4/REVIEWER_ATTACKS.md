...
13. **撤回这么多,前期结论还能信吗?**
    转为优势:撤回全部由更大评测触发且有台账,"several apparent effects from smaller evaluations failed to replicate at larger evaluation scale" 本身是方法学贡献(#13);终局主张全部建立在 529-fam/多 seed/预注册层。
