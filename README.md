...
This repo is consumed on a GPU server via [LLaMA-Factory](https://github.com/hiyouga/LLaMA-Factory).

---

## Quickstart (server training)

```bash
# 1. On the GPU box, clone this repo and LLaMA-Factory
git clone https://github.com/xingweiqu/atomic-repair-sft.git
cd atomic-repair-sft

# 2. (Optional) re-validate the data is intact
